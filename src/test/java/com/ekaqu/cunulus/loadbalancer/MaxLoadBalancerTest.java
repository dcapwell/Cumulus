...
public class MaxLoadBalancerTest {
  ...
  public void emptyList() {
    LoadBalancer<String> lb = new MaxLoadBalancer<String>(Ordering.<String>natural());
    for(int i = 0; i < 10; i++) {
  ...
  public void multiElementList() {
    LoadBalancer<Integer> lb = new MaxLoadBalancer<Integer>(Ordering.<Integer>natural());
  ...
  public void emptyComparable() {
    LoadBalancer<String> lb = new MaxLoadBalancer<String>(null);
  }
}
