...
public final class PoolBuilder<T> {
   ...
   * Build a new ExecutingPool.
   *
   * @param retryer used for retrying {@link ExecutingPool#execute(com.ekaqu.cumulus.util.Block)}
   * @return newly created pool
   */
  ...
  public final class KeyedPoolBuilder<K, V> {
    ...
    /**
     * Build a new ExecutingPool backed by a KeyedPool with retires\ for {@link ExecutingPool#execute(com.ekaqu.cumulus.util.Block)}.
     *
