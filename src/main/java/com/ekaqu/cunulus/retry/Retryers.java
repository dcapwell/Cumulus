...
public final class Retryers {
  ...
  /**
   * Protects users from being able to create this class.
   */
  private Retryers() {
  }
   ...
   * @return new retyer
   */
  public static ListeningRetryer newListeningRetryer(final int maxRetries, final BackOffPolicy policy,
   ...
   * @return new retyer
   */
  public static ListeningRetryer newExponentialBackoffListeningRetryer(final int maxRetries,
                                                                       final ExecutorService executorService) {
